...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname:"DennyChef", email:"dennychef@mail.com",
  ...
  test 'email should be lowercase before hitting databse' do
  ...
  test 'password should be at least have 5 characters' do
